...
export type MentorWhereInput = {
  ...
  university?: Prisma.StringFilter<"Mentor"> | string
  department?: Prisma.StringFilter<"Mentor"> | string
  documents?: Prisma.JsonNullableListFilter<"Mentor">
  ...
  rejectionReason?: Prisma.StringNullableFilter<"Mentor"> | string | null
...
export type MentorScalarWhereWithAggregatesInput = {
  ...
  university?: Prisma.StringWithAggregatesFilter<"Mentor"> | string
  department?: Prisma.StringWithAggregatesFilter<"Mentor"> | string
  documents?: Prisma.JsonNullableListFilter<"Mentor">
  ...
  rejectionReason?: Prisma.StringNullableWithAggregatesFilter<"Mentor"> | string | null
}
...
export type MentorCreateInput = {
  ...
  university: string
  department: string
  documents?: Prisma.MentorCreatedocumentsInput | runtime.InputJsonValue[]
  bio?: string | null
  hourlyRate: number
  isVerified?: boolean
  walletBalance?: number
...
export type MentorUpdateInput = {
  ...
  documents?: Prisma.MentorUpdatedocumentsInput | runtime.InputJsonValue[]
...
export type MentorCreatedocumentsInput = {
  set: runtime.InputJsonValue[]
}

export type MentorUpdatedocumentsInput = {
  set?: runtime.InputJsonValue[]
...
export type MentorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "university" | "department" | "documents" | "bio" | "hourlyRate" | "isVerified" | "walletBalance" | "verificationStatus" | "rejectionReason", ExtArgs["result"]["mentor"]>
...
export interface MentorFieldRefs {
  ...
  readonly university: Prisma.FieldRef<"Mentor", 'String'>
  readonly department: Prisma.FieldRef<"Mentor", 'String'>
  readonly documents: Prisma.FieldRef<"Mentor", 'Json[]'>
  ...
  readonly rejectionReason: Prisma.FieldRef<"Mentor", 'String'>
}
